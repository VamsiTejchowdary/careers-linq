...
export default function CareersPage() {
  ...
  const ctaContent = [
    {
      title: "Join Our Team",
      description: "Discover exciting opportunities to grow your career with us",
            ...
            <div className="flex items-center">
              <Link href="/" className="flex-shrink-0 flex items-center">
                <div className="h-10 w-10 relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center text-white font-bold text-2xl">L</div>
                </div>
                <span className="ml-3 text-xl font-bold text-gray-900">Linq</span>
              </Link>
              <div className="hidden md:ml-6 md:flex md:space-x-8">
                <Link href="https://linqapp.com/" className="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 hover:text-gray-900">
                  Home
                </Link>
                <Link href="https://linqapp.com/linq-one" className="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 hover:text-gray-900">
                  Linq One
                </Link>
                <Link href="/careers" className="inline-flex items-center px-1 pt-1 border-b-2 border-indigo-500 text-sm font-medium text-indigo-600">
                  Careers
                </Link>
                <Link href="https://linqapp.com/support" className="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 hover:text-gray-900">
                  Support
                </Link>
              </div>
            </div>
            <div className="hidden md:ml-6 md:flex md:items-center">
              <Link href="/#openings" className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                View Jobs
              </Link>
            </div>
        ...
        <div className={`${isNavOpen ? 'block' : 'hidden'} md:hidden`}>
          ...
          <div className="pt-4 pb-3 border-t border-gray-200">
            <div className="flex items-center px-4">
              <Link href="/contact" className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                Apply Now
              </Link>
            </div>
          </div>
          ...
          <div className="text-center max-w-4xl transform transition-all duration-700 animate-fadeIn">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fadeInUp">
              <span className="text-white inline-block relative overflow-hidden">
                ...
                <span className="absolute bottom-0 left-0 w-full h-1 bg-white transform translate-x-full animate-slideInFromRight" style={{ animationDelay: "0.5s", animationDuration: "1s" }}></span>
              </span>
            </h1>
            <p className="text-xl md:text-2xl text-white/90 mb-10 transform transition-all duration-500 animate-fadeInUp" style={{ animationDelay: "0.3s" }}>
      ...
      <section className="py-12 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="relative overflow-hidden rounded-3xl shadow-2xl">
            <div className="flex transition-transform duration-500 ease-in-out" style={{ transform: `translateX(-${activeCTA * 100}%)` }} ref={ctaSliderRef}>
              {ctaContent.map((cta, index) => (
                <div key={index} className={`w-full flex-shrink-0 bg-gradient-to-r ${cta.bgColor} p-8 md:p-16`}>
                  <div className="max-w-xl">
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">{cta.title}</h2>
                    <p className="text-lg md:text-xl text-white/90 mb-8">{cta.description}</p>
                    <a href={cta.buttonLink} className="px-6 py-3 bg-white text-indigo-600 rounded-full font-bold text-lg hover:bg-opacity-90 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1 inline-block">
                      {cta.buttonText}
                    </a>
                  </div>
                </div>
            ...
            <div className="absolute bottom-4 left-0 right-0 flex justify-center space-x-2">
              {ctaContent.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full ${index === activeCTA ? 'bg-white' : 'bg-white/50'}`}
            ...
            <div className="relative h-96 w-full">
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl flex items-center justify-center">
                <div className="text-center">
                  <svg className="w-32 h-32 mx-auto text-white/50 mb-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 4.5C7 4.5 2.73 7.61 1 12C2.73 16.39 7 19.5 12 19.5C17 19.5 21.27 16.39 23 12C21.27 7.61 17 4.5 12 4.5ZM12 17C9.24 17 7 14.76 7 12C7 9.24 9.24 7 12 7C14.76 7 17 9.24 17 12C17 14.76 14.76 17 12 17ZM12 9C10.34 9 9 10.34 9 12C9 13.66 10.34 15 12 15C13.66 15 15 13.66 15 12C15 10.34 13.66 9 12 9Z" fill="currentColor"/>
                  </svg>
                  <h3 className="text-2xl font-bold text-white mb-2">Our Mission</h3>
                  <p className="text-white/80 px-8">Creating meaningful professional connections in a digital world</p>
                </div>
              </div>
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2">Our Growth</h3>
                  <p className="text-white/80 px-8">Expanding our reach to connect professionals worldwide</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 md:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 animate-on-scroll">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Our Key Values</h2>
            <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto">These principles guide everything we do at Linq and shape our company culture</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                title: "Innovation",
                description: "We embrace change and continuously innovate to stay ahead in a rapidly evolving digital landscape."
              },
              {
                icon: (
                  <svg className="w-10 h-10 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                title: "Collaboration",
                description: "We work together across teams and disciplines to achieve our shared vision and goals."
              },
              {
                icon: (
                  <svg className="w-10 h-10 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                title: "Integrity",
                description: "We act with honesty and transparency in all our interactions, building trust with our team and users."
              }
            ].map((value, index) => (
              <div key={index} className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 animate-on-scroll">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 animate-on-scroll">
            ...
            <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto">
              Explore opportunities to join our innovative team and make an impact.
            </p>
          </div>

          {loading ? (
            <div className="text-center text-gray-600 animate-pulse">Loading job postings...</div>
          ) : error ? (
      ...
      <section id="culture" className="py-16 md:py-24 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 animate-on-scroll">
            ...
            <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto">
              Discover what makes working at Linq a unique and rewarding experience.
            </p>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center">
              ...
              <div>
                <p className="text-lg md:text-xl text-gray-700 italic mb-4">
                  "Joining Linq has been a game-changer. The supportive culture and innovative projects have accelerated my growth beyond what I imagined."
                </p>
                <div>
                  <h4 className="text-lg font-bold text-gray-900">Sarah Johnson</h4>
                  <p className="text-gray-600">Senior Software Engineer, 2 years at Linq</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <div>
            ...
            <div className="flex space-x-4">
              {[
                { icon: "M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z", platform: "Facebook" },
                { icon: "M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84", platform: "Twitter" },
                { icon: "M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z", platform: "LinkedIn" },
              ].map((social, index) => (
                <a
                  key={index}
                  href="#"
